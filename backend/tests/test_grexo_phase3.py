"""GREXO AI Phase 3 - Payments / Subscriptions / Admin Panel API tests."""
import os
import re
import uuid
import base64
...
@pytest.fixture(scope="module")
def user_a():
    email = f"test_p3_userA_{uuid.uuid4().hex[:8]}@Grexo-AI.com"
...
@pytest.fixture(scope="module")
def user_b():
    email = f"test_p3_userB_{uuid.uuid4().hex[:8]}@Grexo-AI.com"
